...
import com.fedchenko.mafiaassistant.databinding.StateChangeTimerFragmentLayouteBinding
...
class StateChangeTimerFragment : Fragment() {
    ...
    private lateinit var binding: StateChangeTimerFragmentLayouteBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.state_change_timer_fragment_layoute,container,false)
        return binding.root
    }
